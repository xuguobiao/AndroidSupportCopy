...
// */
//public class TabLayout1 extends HorizontalScrollView {
//
...
//
//    /**
//     * Gravity used to fill the {@link TabLayout1} as much as possible. This option only takes effect
...
//
//    /**
//     * Gravity used to lay out the tabs in the center of the {@link TabLayout1}.
//     *
//     * @see #setTabGravity(int)
//     * @see #getTabGravity()
//     */
...
//    }
//
//    public TabLayout1(Context context, AttributeSet attrs) {
//        this(context, attrs, 0);
//    }
//
//    public TabLayout1(Context context, AttributeSet attrs, int defStyleAttr) {
...
//
//        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TabLayout1,
//                defStyleAttr, R.style.Widget_Design_TabLayout);
//
//        mTabStrip.setSelectedIndicatorHeight(
//                a.getDimensionPixelSize(R.styleable.TabLayout1_tabIndicatorHeight, 0));
//        mTabStrip.setSelectedIndicatorColor(a.getColor(R.styleable.TabLayout1_tabIndicatorColor, 0));
//
//        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
//                .getDimensionPixelSize(R.styleable.TabLayout1_tabPadding, 0);
//        mTabPaddingStart = a.getDimensionPixelSize(R.styleable.TabLayout1_tabPaddingStart,
//                mTabPaddingStart);
//        mTabPaddingTop = a.getDimensionPixelSize(R.styleable.TabLayout1_tabPaddingTop,
//                mTabPaddingTop);
//        mTabPaddingEnd = a.getDimensionPixelSize(R.styleable.TabLayout1_tabPaddingEnd,
//                mTabPaddingEnd);
//        mTabPaddingBottom = a.getDimensionPixelSize(R.styleable.TabLayout1_tabPaddingBottom,
//                mTabPaddingBottom);
//
//        mTabTextAppearance = a.getResourceId(R.styleable.TabLayout1_tabTextAppearance,
//                R.style.TextAppearance_Design_Tab);
//
//        if (a.hasValue(R.styleable.TabLayout1_tabTextColor)) {
//            // If we have an explicit text color set, use it instead
//            mTabTextColors = a.getColorStateList(R.styleable.TabLayout1_tabTextColor);
//        }
//
//        if (a.hasValue(R.styleable.TabLayout1_tabSelectedTextColor)) {
//            // We have an explicit selected text color set, so we need to make merge it with the
//            // current colors. This is exposed so that developers can use theme attributes to set
//            // this (theme attrs in ColorStateLists are Lollipop+)
//            final int selected = a.getColor(R.styleable.TabLayout1_tabSelectedTextColor, 0);
//            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
//        }
//
//        mRequestedTabMinWidth = a.getDimensionPixelSize(R.styleable.TabLayout1_tabMinWidth,
//                INVALID_WIDTH);
//        mRequestedTabMaxWidth = a.getDimensionPixelSize(R.styleable.TabLayout1_tabMaxWidth,
//                INVALID_WIDTH);
//        mTabBackgroundResId = a.getResourceId(R.styleable.TabLayout1_tabBackground, 0);
//        mContentInsetStart = a.getDimensionPixelSize(R.styleable.TabLayout1_tabContentStart, 0);
//        mMode = a.getInt(R.styleable.TabLayout1_tabMode, MODE_FIXED);
//        mTabGravity = a.getInt(R.styleable.TabLayout1_tabGravity, GRAVITY_FILL);
//        a.recycle();
//
...
//
//    /**
//     * Add a {@link TabLayout1.OnTabSelectedListener} that will be invoked when tab selection
//     * changes.
//     * <p>
...
//
//    /**
//     * Remove the given {@link TabLayout1.OnTabSelectedListener} that was previously added via
...
//
//    /**
//     * Remove all previously added {@link TabLayout1.OnTabSelectedListener}s.
//     */
...
//
//    /**
//     * Returns the current mode used by this {@link TabLayout1}.
//     *
//     * @see #setTabMode(int)
//     */
//
...
//
//    /**
//     * The one-stop shop for setting up this {@link TabLayout1} with a {@link ViewPager}.
//     * <p>
...
//    }
//
//    private void setupWithViewPager(final ViewPager viewPager, boolean autoRefresh,
...
//     * necessary calls back to the provided {@link TabLayout1} so that the tab position is
//     * kept in sync.
//     * <p>
...
//        private final WeakReference<TabLayout1> mTabLayoutRef;
//        private int mPreviousScrollState;
//        private int mScrollState;
//
//        public TabLayoutOnPageChangeListener(TabLayout1 tabLayout) {
...
//            final TabLayout1 tabLayout = mTabLayoutRef.get();
//            if (tabLayout != null) {
...
//
//    /**
//     * A {@link TabLayout1.OnTabSelectedListener} class which contains the necessary calls back
//     * to the provided {@link ViewPager} so that the tab position is kept in sync.
//     */
//    public static class ViewPagerOnTabSelectedListener implements TabLayout1.OnTabSelectedListener {
