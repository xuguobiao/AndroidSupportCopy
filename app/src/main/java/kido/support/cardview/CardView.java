...
import kido.support.ViewCompat;
...
public class CardView extends FrameLayout {
    ...
    private void initialize(Context context) {
        ...
        float radius = ViewCompat.dp2px(context, 2);
        float elevation = ViewCompat.dp2px(context, 2);
        float maxElevation = ViewCompat.dp2px(context, 2);
