...
public abstract class StickyHeader {
    ...
    protected StickyHeader(Context context, View header, int minHeightHeader, HeaderAnimator headerAnimator) {
        mContext = context;
        mHeader = header;
    ...
    /**
     * Init method called when the StickyHeader is created
     */
    protected void init() {
        setupAnimator();
        measureHeaderHeight();
