...
public class StickyHeaderListView extends StickyHeader {

    private final ListView mListView;
    private AbsListView.OnScrollListener mDelegateOnScrollListener;
    private View mFakeHeader;

    StickyHeaderListView(final Context context, final ListView listView, final View header, final int minHeightHeader, final HeaderAnimator headerAnimator) {
    ...
    private class StickyOnScrollListener implements AbsListView.OnScrollListener {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            ...
            //notify the animator
            StickyHeaderListView.this.onScroll(mScrolledYList);
