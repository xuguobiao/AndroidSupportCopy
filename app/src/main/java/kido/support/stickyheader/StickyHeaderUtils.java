...
public class StickyHeaderUtils {
    ...
    public static void setOnTouchListenerOnHeader(View header, View scrollingView, final View.OnTouchListener onTouchListenerOnHeaderDelegate, final boolean allowTouchBehindHeader) {
